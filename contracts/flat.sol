...
// Part: OpenZeppelin/openzeppelin-contracts@4.3.2/ECDSA
...
contract NFT is Ownable, ERC721URIStorage {
    ...
    constructor(string memory baseUri_, PaymentToken1 paymentToken_) ERC721("NFTToken", "NFT") {
        baseUri = baseUri_;
    ...
    function mint(string calldata metadataUri, bytes32 uuid, bytes calldata sig) public {
        ...
        require(keccak256(abi.encodePacked(_msgSender(), metadataUri, address(this))).toEthSignedMessageHash().recover(sig) == owner(), "invalid signature");
