...
export type ContractContext = Web3ContractContext<
  ...
  SpermEvents
>;
export type SpermEvents = 'Approval' | 'OwnershipTransferred' | 'Transfer';
export interface SpermEventsContext {
  Approval(
    parameters: {
...
export interface Sperm {
   ...
   */
  burn(value: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
   ...
   * Type: function
   */
  ejaculation(): MethodReturnContext;
  /**
   * Payable: false
   * Constant: false
   * StateMutability: nonpayable
   ...
   * @param value Type: uint256, Indexed: false
   */
  mint(to: string, value: string): MethodReturnContext;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
