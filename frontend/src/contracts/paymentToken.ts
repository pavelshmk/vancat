...
export type ContractContext = Web3ContractContext<
  PaymentToken,
  PaymentTokenMethodNames,
  PaymentTokenEventsContext,
  PaymentTokenEvents
>;
export type PaymentTokenEvents =
  | 'Approval'
  | 'OwnershipTransferred'
  | 'Transfer';
export interface PaymentTokenEventsContext {
  Approval(
    parameters: {
...
export type PaymentTokenMethodNames =
  | 'new'
  | 'allowance'
  | 'approve'
  | 'balanceOf'
